...
/**
 * Handler for {@link de.hdm.wim.sharedLib.Constants.PubSub.Topic.ML_LEARNING#TOPIC_ID}
 *
...
public class PubSubPushHandlerMlLearning extends HttpServlet {
	...
	private static final Logger LOGGER = Logger.getLogger(PubSubPushHandlerMlLearning.class);
