...
/**
 * Handler for Handler for {@link de.hdm.wim.sharedLib.Constants.PubSub.Topic.TOPIC_1#TOPIC_ID}
 *
 * @author Benedikt Benz
 * @createdOn 04.06.2017
 */
@WebServlet(
	name = "Push with PubSub " + TOPIC_1.HANDLER_ID,
	value = Config.PUSH_ENDPOINT_PREFIX + TOPIC_1.HANDLER_ID
)
