 ...
 */
@WebServlet(
	name = "Push with PubSub " + Config.HANDLER_SEMREP_INFORMATION,
	value = Config.PUSH_ENDPOINT_PREFIX + Config.HANDLER_SEMREP_INFORMATION
)
public class PubSubPushHandlerSemRepInformation extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			LOGGER.info(
				"Handler: " + Config.HANDLER_SEMREP_INFORMATION + " event.getData(): " + event
					.getData());
