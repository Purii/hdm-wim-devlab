...
/**
 * Handler for {@link de.hdm.wim.sharedLib.Constants.PubSub.Topic.SEMREP_INFORMATION#TOPIC_ID}
 *
 * @author Benedikt Benz
 * @createdOn 04.06.2017
 */
@WebServlet(
	name = "Push with PubSub " + SEMREP_INFORMATION.HANDLER_ID,
	value = Config.PUSH_ENDPOINT_PREFIX + SEMREP_INFORMATION.HANDLER_ID
)
public class PubSubPushHandlerSemRepInformation extends HttpServlet {

	private static final Logger LOGGER = Logger.getLogger(PubSubPushHandlerSemRepInformation.class);
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			LOGGER.info(
				"Handler: " + SEMREP_INFORMATION.HANDLER_ID + " event.getData(): " + event
					.getData());
