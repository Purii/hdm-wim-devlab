 ...
 */
@WebServlet(
	name = "Push with PubSub " + Config.HANDLER_CEP_CONTEXT,
	value = Config.PUSH_ENDPOINT_PREFIX + Config.HANDLER_CEP_CONTEXT
)
public class PubSubPushHandlerCepContext extends HttpServlet {

	private static final Logger LOGGER = Logger.getLogger(PubSubPushHandlerCepContext.class);
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			LOGGER.info(
				"Handler: " + Config.HANDLER_CEP_CONTEXT + " event.getData(): " + event.getData());
