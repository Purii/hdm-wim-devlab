    ...
    if ( true) {
        ...
        function drawChart() {
            ...
            function showFullTooltip(row, size, value) {
                ...
                return '<div class="mouseOvertoKill' + '" style="background:#fd9; padding:10px; z-index: 999; position: absolute; border-style:solid;">' +
                    ...
                    data.getColumnLabel(3) + ': ' + value+ 'björn und markus' + ' </div>';
