 ...
 *
 * Handler für publishen und pullen von Events für cepContextEvents
...
public class cepContextHandler extends HttpServlet {

	private static final Logger LOGGER = Logger.getLogger(cepContextHandler.class);
