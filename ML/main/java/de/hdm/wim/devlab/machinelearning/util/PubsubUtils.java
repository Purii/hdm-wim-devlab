...
public final class PubsubUtils {
	...
	/**
	 * Builds a new Pubsub client with default HttpTransport and JsonFactory and
	 * returns it.
	 *
	 * @return Pubsub client.
	 * @throws IOException
	 *             when we can not get the default credentials.
	 */
	 ...
	 *
	 * @param httpTransport
	 *            HttpTransport for Pubsub client.
	 * @param jsonFactory
	 *            JsonFactory for Pubsub client.
	 * @return Pubsub client.
	 * @throws IOException
	 *             when we can not get the default credentials.
	 */
